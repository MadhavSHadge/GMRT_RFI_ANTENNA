...
void forward(int speed, long requiredPulsesforRotation) {         
  long targetEncoderValue = encoderValue + requiredPulsesforRotation;     //calculation for clockwise rotation of motor
...
void backward(int speed, long requiredPulsesforRotation) {        
  long targetEncoderValue = encoderValue - requiredPulsesforRotation;       //calculation for anticlockwise rotation of the motor
  Serial.println("The target encoder value that is calculated is:- ");
  Serial.println(targetEncoderValue);
...
// software interrupt that will stop the motor at any point
void requestStop(){       
  stopRequested = true;
  stopMotor();
}
